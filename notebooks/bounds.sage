...
def generate_macros_file():
    with open("latticefold/benches/macros.rs", "w") as f:
        ...
        f.write("            struct [<DecompParamsWithB $b W $w b $b_small K $k>];\n")
        f.write("            impl DecompositionParams for [<DecompParamsWithB $b W $w b $b_small K $k>] {\n")
        f.write("                const B: u128 = $b;\n")
        f.write("                const L: usize = $l;\n")
        f.write("                const B_SMALL: usize = $b_small;\n")
        f.write("                const K: usize = $k;\n")
        f.write("            }\n")
        f.write("        }\n")
        f.write("    };\n")
        f.write("}\n")
