...
- `cyclotomic-rings`: contains the trait definition of a suitable ring which can be used in the LatticeFold protocol alongside with a few ready-to-use rings and short challenge set machinery.
