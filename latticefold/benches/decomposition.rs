    ...
    // StarkPrime
    {
        ...
        #[allow(clippy::identity_op)]
        {
            run_single_starkprime_scalar_benchmark!(
                &mut group, 1, 15, 512, 8633754724, 1, 92918, 2
            );
            run_single_starkprime_scalar_benchmark!(&mut group, 1, 15, 512, 8615125000, 1, 2050, 3);
            run_single_starkprime_scalar_benchmark!(&mut group, 1, 15, 512, 8540717056, 1, 304, 4);
            run_single_starkprime_scalar_benchmark!(
                &mut group, 1, 15, 1024, 6104921956, 1, 78134, 2
            );
            run_single_starkprime_scalar_benchmark!(
                &mut group, 1, 15, 1024, 6088387976, 1, 1826, 3
            );
            run_single_starkprime_scalar_benchmark!(&mut group, 1, 15, 1024, 5972816656, 1, 278, 4);
            run_single_starkprime_scalar_benchmark!(
                &mut group, 1, 15, 2048, 4317015616, 1, 65704, 2
            );
            run_single_starkprime_scalar_benchmark!(
                &mut group, 1, 15, 2048, 4314825152, 1, 1628, 3
            );
            run_single_starkprime_scalar_benchmark!(&mut group, 1, 15, 2048, 4294967296, 1, 256, 4);
            run_single_starkprime_scalar_benchmark!(
                &mut group,
                1,
                16,
            ...
            run_single_starkprime_scalar_benchmark!(&mut group, 1, 16, 512, 20851360000, 1, 380, 4);
            run_single_starkprime_scalar_benchmark!(
                &mut group,
                1,
                16,
            ...
            run_single_starkprime_scalar_benchmark!(&mut group, 1, 17, 512, 50479304976, 1, 474, 4);
            run_single_starkprime_scalar_benchmark!(
                &mut group,
                1,
                17,
