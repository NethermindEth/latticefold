...
///  # Members
///
/// * `pointshift_sumcheck_proof` - list of non-interactive sumcheck messages.
/// * `theta_s` - The respective MLEs of decomposed `wit.f_hat` evaluated at the $\overrightarrow{r}_0$ challenge point.
/// * `eta_s` - The MLEs of $\\{ M_j \mathbf{z}_i \mid j = 1, 2, \dots, t, i = 1, 2 \dots 2k \\}$ evaluation at the $\overrightarrow{r}_0$ challenge point.
///
